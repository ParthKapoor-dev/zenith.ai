...
const UploadResumePage = () => {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden flex items-center justify-center p-4 max-md:text-sm">
      ...
      >
        <Card className="backdrop-blur-xl bg-white/80 dark:bg-purple-100/10 shadow-2xl border-0 relative">
            ...
            >
              ...
              <div className="flex gap-1 items-center max-md:flex-col">
                ...
                <p className="text-sm text-violet-700 dark:text-cyan-200 text-center">
                  Take the first step towards your dream job. Upload your resume
                  to access AI-powered job matching and career opportunities.
                </p>
              </div>
            </motion.div>
