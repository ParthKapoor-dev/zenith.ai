...
const UserPreferencesPage = () => {
  ...
  const ValidateForm = () => {
    ...
    if (!formData.employmentType) err.push(`Employment Type is required`);
    if (!formData.salaryExpectation) err.push(`salary Expectation is required`);
    if (!formData.currencyType) err.push(`Currency Type is required`);
    if (!formData.salaryPeriod) err.push(`Salary Period is required`);
    if (formData.preferredRole?.length == 0)
      err.push(`Alteast 1 Role is required`);
    if (!formData.availability) err.push(`Job Availability is required`);
        ...
        >
          <div className="max-w-3xl mx-auto ">
            ...
            <ShineBorder
              ...
              className="dark:bg-purple-100/10 shadow-xl "
            >
                ...
                <CardContent className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="relative">
                        ...
                        <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">
                          {
                            currencies.find(
                              (c) => c.code === formData.currencyType
                            )?.symbol
                          }
                        </span>
                      </div>
                      ...
                      <Select
                        ...
                        onValueChange={(value: any) =>
                          setFormData({ ...formData, currencyType: value })
                        }
                      >
                        <SelectTrigger>
                    ...
                    <Alert className="bg-blue-50 text-blue-800 dark:bg-blue-800/20 dark:text-blue-50 border-blue-200 dark:border-blue-900">
                      ...
                      <AlertDescription>
                        Please ensure your salary expectations are realistic and
                        aligned with market standards for better chances of
                        being shortlisted.
                      </AlertDescription>
                    </Alert>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <MultiSelectRoles
                      ...
                      onChange={(roles) =>
                        setFormData({ ...formData, preferredRole: roles })
                      }
                      maxSelections={5}
                    />
                  </div>
